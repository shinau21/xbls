...
raw = """
\033[35m			_  _    ___  _    ____ 
\033[35m			 \/  __ |__] |    [__  
\033[35m			_/\_    |__] |___ ___]
...
def login(user,passwd):
	if (user != "Snowden" and passwd != "Vendeta"):
		return False
	else:
		return True
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;X-BLS. | Devices: [{}] | Spoofed Servers [11] | Server Units [4] | Clients: [549]\x07".format (bots))
		sin = input("\033[32m[\033[35m{}\033[32m@X-BLS]\033[36m$ \033[96m".format(usr)).lower()
		sinput = sin.split(" ")[0]
		if sinput == "cls":
			clean()
			print (banner)
